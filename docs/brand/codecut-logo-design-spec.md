...
| Codecut 3D 标准稿 | 当前选定的 3D 扩展标准：保留黑色金属徽章、白色剪辑块和青色切线，外壳角度参考 Codex 式花瓣动势。 | `docs/brand/assets/codecut-logo-variant-3d-1024.png` |
| Codecut 3D 透明网站稿 | 网站、导航、文档页眉使用的 3D 标志：保留 3D 风格和配色，仅移除白色背景。 | `docs/brand/assets/codecut-logo-variant-3d-transparent-1024.png` |
...
![Codecut 3D standard mark](assets/codecut-logo-variant-3d-1024.png)

![Codecut 3D transparent website mark](assets/codecut-logo-variant-3d-transparent-1024.png)
