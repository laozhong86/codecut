...
import { z } from "zod";
import { queryRunningHubDigitalHumanTask } from "@/lib/ai/providers/runninghub-digital-human-server";
...
export async function GET(request: NextRequest) {
	try {
		...
		const message =
			error instanceof Error ? error.message : "Digital human task query failed";
