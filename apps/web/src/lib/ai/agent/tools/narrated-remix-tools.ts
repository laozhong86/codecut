...
export const applyNarratedRemixPlanTool: AgentTool = {
	...
	description:
		"Validate and apply a Codex-generated NarratedRemixPlan to the current Codecut timeline for narrated-broll templates. This tool consumes existing narration audio, muted video or image B-roll, optional independent controlled text overlays, and captions. Narration may use an explicit timelineStart and durationSec when it should not cover the full timeline, and captions are normalized into readable chunks for the selected captionStyle. It does not call an LLM, generate speech, and does not support TTS, BGM, SFX, effects, or append mode.",
	parameters: {
		type: "object",
		properties: {
			plan: {
